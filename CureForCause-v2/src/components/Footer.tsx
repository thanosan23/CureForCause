        ...
        <>
            <footer id="footer" className="footer p-5 mt-20 flex justify-between bg-sky-600/[.3] shadow-md">
                ...
                <div id="mc_embed_signup_scroll">
                    <h2 className="text-black font-semibold">General Interest</h2>
                    <div className="mc-field-group">
                        ...
                        <input type="submit" name="subscribe" id="mc-embedded-subscribe" className="button p-2 rounded bg-blue-500 text-white ml-2" value="Join" />
                    </div>
                    ...
                    <div aria-hidden="true" style={{position: 'absolute', left: '-5000px'}}>
                        <input type="text" name="b_adbaf9d35dc2355e6970d64f3_0437810db5" tabIndex="-1" value="" />
                    </div>
                </div>
            </form>
                </div>
                <nav>
                    ...
                    <div className="grid grid-flow-col pr-8 gap-4">
                        <a href="https://instagram.com/cureforcause?igshid=MTk0NTkyODZkYg%3D%3D&utm_source=qr"><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="30" height="30" fill="url(#gradient)" viewBox="0 0 30 30">
                            <defs>
                        ...
                        <a href="mailto:cureforcause.info@gmail.com">
