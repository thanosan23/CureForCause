const Footer = () => {
    return (
        <>
            <footer id="footer" className="footer p-10">
                <aside>
                ...
                <nav>
                    <header className="text-black font-semibold">SOCIAL</header>
                    <div className="grid grid-flow-col gap-4">
                        <a href="https://instagram.com/cureforcause?igshid=MTk0NTkyODZkYg%3D%3D&utm_source=qr"><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="30" height="30" viewBox="0 0 30 30">
